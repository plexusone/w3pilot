...
- **Unreachable statement removed** - Fixed dead code in webpilot-mcp main
...
```bash
go get github.com/plexusone/webpilot@v0.3.0
```
...
- [GoDoc](https://pkg.go.dev/github.com/plexusone/webpilot) - API reference
- [CHANGELOG](https://github.com/plexusone/webpilot/blob/main/CHANGELOG.md) - Version history
